...
describe('Custom Tests', function () {
  ...
  it('[assignment] iii. see assignment doc for details', async () => {
      ...
      const bobEthAddress = ethers.Wallet.createRandom().address
      ...
      // Alice withdraws all remaining funds in L1
      const aliceWithdrawAmount = utils.parseEther('0.07')
      const aliceEthAddress = ethers.Wallet.createRandom().address
